...
% Cascadilla Proceedings Project copyright notice, and "hyphenate" to restore
% normal LaTeX end-of-line hyphenation. You can also give "pagenums" to
% generate page numbers (contrary to the Cascadilla stylesheet); page numbers
% start on the second page if the copyright notice is present on the first
% page. You may also give "notimes" to generate a document without the Times New
% Roman font required by the Cascadilla stylesheet---your system's default font
% (most likely Computer Modern) will be used instead, or anything else that you
...
% bottom of file).
% cascadilla.cls automatically includes the natbib for you to use when citing
